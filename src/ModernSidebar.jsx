  ...
  return (
    <div
      className="
        ...
        text-white flex flex-col p-2 sm:p-5
    ...
    >
      ...
      {/* Badge */}
      <div className="hidden sm:block bg-gradient-to-r from-purple-500 to-pink-500 px-3 py-1 rounded-full w-fit mb-6">
        🔥 Hot Deals
      </div>

      {/* MENU */}
      <nav className="flex flex-col gap-4 text-sm items-center sm:items-start">
      ...
      {/* PROFILE */}
      <div className="mt-auto flex items-center justify-center sm:justify-start bg-[#1e293b] p-2 sm:p-3 rounded-xl">
